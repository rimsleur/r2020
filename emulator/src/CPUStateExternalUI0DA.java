public class CPUStateExternalUI0DA implements SetValue, GetValue
{
	public BitState b7;
	public BitState b6;
	public BitState b5;
	...
	public CPUStateExternalUI0DA (Boolean init)
	{
		if (init)
		{
			this.b7 = BitState.L;
	...
	public CPUStateExternalUI0DA copy ()
	{
		CPUStateExternalUI0DA da = new CPUStateExternalUI0DA (false);
		da.b7 = this.b7;
		da.b6 = this.b6;
		da.b5 = this.b5;
		da.b4 = this.b4;
