public class CPUStateExternalUI1IOD implements SetValue, GetValue
{
	public BitState b7;
	public BitState b6;
	public BitState b5;
	...
	public CPUStateExternalUI1IOD (Boolean init)
	{
		if (init)
		{
			this.b7 = BitState.L;
	...
	public CPUStateExternalUI1IOD copy ()
	{
		CPUStateExternalUI1IOD iod = new CPUStateExternalUI1IOD (false);
		iod.b7 = this.b7;
		iod.b6 = this.b6;
		iod.b5 = this.b5;
		iod.b4 = this.b4;
