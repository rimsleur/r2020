public class CPUStateExternalUI2DA implements SetValue, GetValue
{
	public BitState b7;
	public BitState b6;
	public BitState b5;
	...
	public CPUStateExternalUI2DA (Boolean init)
	{
		if (init)
		{
			this.b7 = BitState.L;
	...
	public CPUStateExternalUI2DA copy ()
	{
		CPUStateExternalUI2DA da = new CPUStateExternalUI2DA (false);
		da.b7 = this.b7;
		da.b6 = this.b6;
		da.b5 = this.b5;
		da.b4 = this.b4;
