public class CPUStateInternalARG1R implements SetValue, GetValue
{
	public BitState b7;
	public BitState b6;
	public BitState b5;
	...
	public CPUStateInternalARG1R (Boolean init)
	{
		if (init)
		{
			this.b7 = BitState.L;
	...
	public CPUStateInternalARG1R copy ()
	{
		CPUStateInternalARG1R arg1r = new CPUStateInternalARG1R (false);
		arg1r.b7 = this.b7;
		arg1r.b6 = this.b6;
		arg1r.b5 = this.b5;
		arg1r.b4 = this.b4;
