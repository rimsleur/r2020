public class I00StateExternalUI1IS implements SetValue, GetValue
{
	public BitState b7;
	public BitState b6;
	public BitState b5;
	...
	public I00StateExternalUI1IS(Boolean init)
	{
		if (init)
		{
			this.b7 = BitState.L;
	...
	public I00StateExternalUI1IS copy ()
	{
		I00StateExternalUI1IS i00StateExternalUI1IS = new I00StateExternalUI1IS(false);
		i00StateExternalUI1IS.b7 = this.b7;
		i00StateExternalUI1IS.b6 = this.b6;
		i00StateExternalUI1IS.b5 = this.b5;
		i00StateExternalUI1IS.b4 = this.b4;
		i00StateExternalUI1IS.b3 = this.b3;
		i00StateExternalUI1IS.b2 = this.b2;
		i00StateExternalUI1IS.b1 = this.b1;
		i00StateExternalUI1IS.b0 = this.b0;
		return i00StateExternalUI1IS;
	}
