public class I00StateUIBus1
{
    private static I00StateUIBus1 instance;

    private BitState dir;
    private BitState ereq;
    private BitState stb;
    private BitState irdy;
    private I00StateUIBus1ISB isb;
    private I00StateUIBus1DB db;
...
//        this.db.b0 = db.b0;
    ...
    public I00StateUIBus1ISB getIsbBitState()
    {
        I00StateUIBus1ISB isb = new I00StateUIBus1ISB(false);
        isb.b7 = this.isb.b7;
        isb.b6 = this.isb.b6;
        isb.b5 = this.isb.b5;
        isb.b4 = this.isb.b4;
    ...
    public I00StateUIBus1DB getDbBitState()
    {
        I00StateUIBus1DB db = new I00StateUIBus1DB(false);
        db.b7 = this.db.b7;
        db.b6 = this.db.b6;
        db.b5 = this.db.b5;
        db.b4 = this.db.b4;
    ...
    public I00StateUIBus1()
    {
        setDir(BitState.L);
        setEreq(BitState.L);
        setStb(BitState.L);
        setIrdy(BitState.H);
        this.isb = new I00StateUIBus1ISB(true);
        this.db = new I00StateUIBus1DB(true);
    }

    public static I00StateUIBus1 getInstance()
    {

        if (instance == null)
        {
            instance = new I00StateUIBus1();
        }
